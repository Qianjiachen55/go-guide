...
// 	protoc        v3.19.2
// source: ecommerce/ProductInfo.proto
...
func (x *Product) Reset() {
	*x = Product{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ecommerce_ProductInfo_proto_msgTypes[0]
...
func (*Product) Descriptor() ([]byte, []int) {
	return file_ecommerce_ProductInfo_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProductID) Reset() {
	*x = ProductID{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ecommerce_ProductInfo_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProductID) Descriptor() ([]byte, []int) {
	return file_ecommerce_ProductInfo_proto_rawDescGZIP(), []int{1}
}
...
var File_ecommerce_ProductInfo_proto protoreflect.FileDescriptor

var file_ecommerce_ProductInfo_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65, 0x2f, 0x50, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x65,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65, 0x22, 0x65, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64,
	...
	0x74, 0x42, 0x0c, 0x5a, 0x0a, 0x2f, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_ecommerce_ProductInfo_proto_rawDescOnce sync.Once
	file_ecommerce_ProductInfo_proto_rawDescData = file_ecommerce_ProductInfo_proto_rawDesc
)

func file_ecommerce_ProductInfo_proto_rawDescGZIP() []byte {
	file_ecommerce_ProductInfo_proto_rawDescOnce.Do(func() {
		file_ecommerce_ProductInfo_proto_rawDescData = protoimpl.X.CompressGZIP(file_ecommerce_ProductInfo_proto_rawDescData)
	})
	return file_ecommerce_ProductInfo_proto_rawDescData
}

var file_ecommerce_ProductInfo_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_ecommerce_ProductInfo_proto_goTypes = []interface{}{
	(*Product)(nil),   // 0: ecommerce.Product
	(*ProductID)(nil), // 1: ecommerce.ProductID
}
var file_ecommerce_ProductInfo_proto_depIdxs = []int32{
...
func init() { file_ecommerce_ProductInfo_proto_init() }
func file_ecommerce_ProductInfo_proto_init() {
	if File_ecommerce_ProductInfo_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ecommerce_ProductInfo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ecommerce_ProductInfo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ecommerce_ProductInfo_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_ecommerce_ProductInfo_proto_goTypes,
		DependencyIndexes: file_ecommerce_ProductInfo_proto_depIdxs,
		MessageInfos:      file_ecommerce_ProductInfo_proto_msgTypes,
	}.Build()
	File_ecommerce_ProductInfo_proto = out.File
	file_ecommerce_ProductInfo_proto_rawDesc = nil
	file_ecommerce_ProductInfo_proto_goTypes = nil
	file_ecommerce_ProductInfo_proto_depIdxs = nil
}
...
var _ProductInfo_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "ecommerce/ProductInfo.proto",
}
